...
Sau đó ở terminal hoặc git bash dùng lệnh: git clone https://github.com/TamiaoNguyen/petri-net-project.git để clone project về máy<br>
Đợi clone về sau đó dùng lệnh cd petri-net-project để nhập vào project<br>
