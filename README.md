...
Nhập vào branch bằng cách: <pre>git fetch</pre> và <pre>git checkout feature/tên-branch</pre><br>
Viết code xong có thể đẩy branch lên github: <pre>git push -u origin feature/tên-branch</pre><br>
